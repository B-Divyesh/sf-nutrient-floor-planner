...
const output = '.factory/evidence/verification-10-live-qa.json';
...
try {
  ...
  await page.screenshot({ path: '.factory/evidence/verification-10-home-mobile.png', fullPage: true });
  ...
  await page.screenshot({ path: '.factory/evidence/verification-10-demo-mobile.png', fullPage: true });
  ...
  const notFoundResponse = await page.goto(`${origin}/verification-10-not-found`);
